...
-(void)setThreeModel:(ThreeModel *)threeModel{
    ...
    self.lblSubtitle.text = [NSString stringWithFormat:@"%@",threeModel.content];
    [self.imgIcon sd_setImageWithURL:[NSURL URLWithString:threeModel.imgUrl] placeholderImage:[UIImage imageNamed:@"303"]];
